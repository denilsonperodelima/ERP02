package com.velocinotech.erp02.resources.exceptions;
...
import com.velocinotech.erp02.services.exceptions.AuthorizationException;
import com.velocinotech.erp02.services.exceptions.DataIntegrityException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		...
		//e.getMessage()
		ValidationError err = new ValidationError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Erro de validação", null, request.getRequestURI());
